...
public class AddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        final ItemArrayAdapter adapter=new ItemArrayAdapter(AddActivity.this,R.layout.edit_items,listEditItem);
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            name.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    Toast.makeText(AddActivity.this, tmp, Toast.LENGTH_SHORT).show();
                    switch (tmp) {
                        case "Date":
                            //这里弹出时间选择窗口
                        ...
                        case "Period":
                            AlertDialog.Builder dialog_period = new AlertDialog.Builder(AddActivity.this);
                        ...
                        case "Image":
                            ...
                            AlertDialog.Builder radioDialog = new AlertDialog.Builder(AddActivity.this);
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    switch(which){
                                        case 0:
                                            ...
                                            Toast.makeText(AddActivity.this,"pic1",Toast.LENGTH_SHORT).show();
                                            break;
                                        case 1:
                                            item.setImage(R.drawable.pic2);
                                            Backgroundimg.setImageResource(R.drawable.pic2);
                                            Toast.makeText(AddActivity.this,"pic2",Toast.LENGTH_SHORT).show();
                                            break;
                                        case 2:
                                            item.setImage(R.drawable.pic3);
                                            Backgroundimg.setImageResource(R.drawable.pic3);
                                            Toast.makeText(AddActivity.this,"pic3",Toast.LENGTH_SHORT).show();
                                            break;
                                        case 3:
                                            item.setImage(R.drawable.pic4);
                                            Backgroundimg.setImageResource(R.drawable.pic4);
                                            Toast.makeText(AddActivity.this,"pic4",Toast.LENGTH_SHORT).show();
                                            break;
                                        case 4:
                                            item.setImage(R.drawable.pic5);
                                            Backgroundimg.setImageResource(R.drawable.pic5);
                                            Toast.makeText(AddActivity.this,"pic5",Toast.LENGTH_SHORT).show();
                                            break;
                                        default:
                                    }
                                }
                        ...
                        case "Stick":
                            ...
                            AlertDialog.Builder stickdiolog = new AlertDialog.Builder(AddActivity.this);
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    switch(which){
                                        case 0:
                                            ...
                                            Toast.makeText(AddActivity.this,"置顶",Toast.LENGTH_SHORT).show();
                                            break;
                                        case 1:
                                            item.setStick(false);
                                            Toast.makeText(AddActivity.this,"取消置顶",Toast.LENGTH_SHORT).show();
                                            item.setDescription("");
                                            break;
                                        default:
                                    }
